...
-- -----------------------------------------------------
-- Table `movies`.`ratings_results`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `movies`.`ratings_results` (
...
-- -----------------------------------------------------
-- Table `movies`.`title_results`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `movies`.`title_results` (
  `tconst` VARCHAR(11) NULL DEFAULT NULL,
